...
class PretrainerNSP(_commonPretrainer):
    ...
    def __init__(self, model_path, optimizer, params, tokenizer_setup):
        ...
        # because max_pe changed
        orig = self.elems['preprocessor']
        preprocessor = model.Preprocessor(params)
        preprocessor.embedder.embedding = orig.embedder.embedding
        preprocessor.embedder.dropout = orig.embedder.dropout
        preprocessor.iso_enc_encoder = orig.iso_enc_encoder
        preprocessor.iso_lat_encoder = orig.iso_lat_encoder
        self.elems['preprocessor'] = preprocessor
